...
def get_patent_data_by_number(patent_number):
    ...
    if patent_term_dictionary == {}:
        ...
        patent.term_adjustment = patent_term_dictionary[
            'patentTermAdjustmentData']['adjustmentTotalQuantity']
    patent.terminal_disclaimer = find_terminal_disclaimer(
        patent_term_dictionary)
...
def patent_term_expire(patent_number):
    """Returns the patent term string that is appropriate.
